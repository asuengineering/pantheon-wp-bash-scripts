...
SITENAMES="asu-divi-setup-site richard-king git-photography semte research-themes ssebe-2018 ssebe-certs aspace nasa-leadership manufacturing cidse-2017 polytechnic-school career-center-2018 aeesp-2019-conference photonics-innovation kristin-test front-end-planning e2-camp asu-mayo-imaging cement-mobasher ascecrc2020 semte-charlie kumar-ankit global-ambassador semte-dev gutenberg-asu-divi-test 2019-engineering invest2020 robotics-ms aiaa2 asu-divi-upstreamtesting"
...
for thissite in $SITENAMES; do
    ...
    for thisenv in $SITEENVS; do
        ...
        if [[ "$thisenv" == "dev" ]]; then
            ...
            terminus wp $thissite.$thisenv -- option update "classic-editor-replace" "classic"
